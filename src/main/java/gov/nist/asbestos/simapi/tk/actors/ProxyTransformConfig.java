...
import gov.nist.asbestos.simapi.toolkit.configDatatypes.client.FhirVerb;
...
class ProxyTransformConfig  {
    ...
    private gov.nist.asbestos.simapi.toolkit.configDatatypes.client.FhirVerb fhirVerb;
     ...
     public ProxyTransformConfig(TransactionType transactionType, TransactionDirection transactionDirection, gov.nist.asbestos.simapi.toolkit.configDatatypes.client.FhirVerb fhirVerb, String transformClassName) {
