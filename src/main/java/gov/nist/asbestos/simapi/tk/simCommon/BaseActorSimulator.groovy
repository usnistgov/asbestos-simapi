...
abstract public class BaseActorSimulator {
    ...
    abstract  public boolean run(gov.nist.asbestos.simapi.tk.actors.TransactionType transactionType, gov.nist.asbestos.simapi.tk.stubs.MessageValidatorEngine mvc, String validation) throws IOException;
