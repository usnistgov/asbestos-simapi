...
@TypeChecked
 class SimulatorBuilder {
    ...
    */
    ...
    private SimConfig create(String id, String user, gov.nist.asbestos.simapi.toolkit.configDatatypes.server.SimulatorActorType actorType, String environmentName) throws ToolkitServiceException {
     ...
     */
     DocumentSource createDocumentSource(String id, String user, String environmentName) throws ToolkitServiceException {
        ...
        src.engine = engine;
        src.config =  engine.create(id, user, gov.nist.asbestos.simapi.toolkit.configDatatypes.server.SimulatorActorType.DOCUMENT_SOURCE, environmentName);
     ...
     */
     DocumentConsumer createDocumentConsumer(String id, String user, String environmentName) throws ToolkitServiceException {
        ...
        cons.engine = engine;
        cons.config =  engine.create(id, user, gov.nist.asbestos.simapi.toolkit.configDatatypes.server.SimulatorActorType.DOCUMENT_CONSUMER, environmentName);
        return cons;
    }
    /**
...
//    }
     ...
     */
     DocumentRecipient createDocumentRecipient(String id, String user, String environmentName) throws ToolkitServiceException {
        ...
        act.engine = engine;
        act.config = engine.create(id, user, gov.nist.asbestos.simapi.toolkit.configDatatypes.server.SimulatorActorType.DOCUMENT_RECIPIENT, environmentName);
        return act;
    }
     ...
     IFhirServer createFhirServer(String id, String user, String environmentName) throws ToolkitServiceException {
        ...
        server.config = engine.create(id, user, gov.nist.asbestos.simapi.toolkit.configDatatypes.server.SimulatorActorType.FHIR_SERVER, environmentName);
        return server;
    }
     ...
     */
     DocumentRegRep createDocumentRegRep(String id, String user, String environmentName) throws ToolkitServiceException {
        ...
        act.engine = engine;
        act.config = engine.create(id, user, gov.nist.asbestos.simapi.toolkit.configDatatypes.server.SimulatorActorType.REPOSITORY_REGISTRY, environmentName);
        return act;
    }
     ...
     DocumentRepository createDocumentRepository(String id, String user, String environmentName)  throws ToolkitServiceException {
        ...
        act.engine = engine;
        act.config = engine.create(id, user, gov.nist.asbestos.simapi.toolkit.configDatatypes.server.SimulatorActorType.REPOSITORY, environmentName);
        return act;
    }
     ...
     RespondingGateway createRespondingGateway(String id, String user, String environmentName) throws ToolkitServiceException {
        ...
        act.engine = engine;
        act.config = engine.create(id, user, gov.nist.asbestos.simapi.toolkit.configDatatypes.server.SimulatorActorType.RESPONDING_GATEWAY, environmentName);
        return act;
    }
     ...
     InitiatingGateway createInitiatingGateway(String id, String user, String environmentName) throws ToolkitServiceException {
        ...
        act.engine = engine;
        act.config = engine.create(id, user, gov.nist.asbestos.simapi.toolkit.configDatatypes.server.SimulatorActorType.INITIATING_GATEWAY, environmentName);
        return act;
    }
