...
@TypeChecked
 class Sites {
	...
	final  static Site FAKE_SITE = new Site(FAKE_SITE_NAME, TestSession.DEFAULT_TEST_SESSION);
...
//		validate();
	...
	// about this special site.
	 void buildRepositoriesSite(TestSession testSession) {
	 ...
	 List<Site> getSitesWithActor(ActorType actorType, TestSession testSession) {
...
//	}
    ...
    */
    Site getSiteForRepUid(String uid, TransactionBean.RepositoryType repType) {
	 ...
	 List<String> getSiteNamesWithActor(ActorType actorType, TestSession testSession) throws Exception {
...
//	}
	 ...
	 Site getDefaultSite(TestSession testSession) throws Exception {
	 ...
	 Site getSite(String siteName, TestSession testSession) throws Exception {
