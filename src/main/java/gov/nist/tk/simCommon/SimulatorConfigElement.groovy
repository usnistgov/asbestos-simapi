...
class SimulatorConfigElement implements Serializable {
	...
	SimulatorConfigElement(String name, ParamType type, PatientErrorMap value) {
		this.name = name;
		this.type = type;
	...
	PatientErrorMap asPatientErrorMap() {
...
//		buf.append(" values=").append(values);
	...
	void setPatientErrorMapValue(PatientErrorMap o) { patientErrorMap = o; valueType = ValueType.PATIENT_ERROR_MAP; }
	PatientErrorMap getPatientErrorMapValue () { return patientErrorMap; }
